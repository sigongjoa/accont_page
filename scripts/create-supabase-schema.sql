...
-- Create triggers for updated_at for new tables
CREATE TRIGGER update_mcp_updated_at BEFORE UPDATE ON mcp
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_industry_codes_updated_at BEFORE UPDATE ON industry_codes
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
